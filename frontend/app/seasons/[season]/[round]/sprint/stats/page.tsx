    ...
    <div className="w-full max-h-[calc(100vh-44px)] flex flex-col">
      <div className="flex flex-row w-full px-3 pb-3">
        <div className="flex flex-col">
          <h1 className="text-3xl font-bold">{race?.name} · Sprint</h1>
          <h2 className="text-neutral-400">{race?.startDate} - {race?.endDate} · {race?.circuit}</h2>
        </div>
        <div className="grow" />
        <div className="flex flex-row my-auto">
          <Button variant="link" className="hover:cursor-pointer" onClick={() => redirect(`/seasons/${season}/${round}/sprint`, RedirectType.push)}>View Results</Button>
